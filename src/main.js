...
function welcomeMessage() {
	if (localStorage.getItem("firstBoot") == null) {
		showErrorModal(
			"Welcome to Gooey Startpage, thanks for using this extension! Head over to the settings menu in the top right to customise your new tab screen."
		);
	}
}
...
function updateDate() {
	...
	dateDisplay.innerText = `${fullMonthName(
